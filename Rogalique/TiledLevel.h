...
// прямоугольник-вырез). Игрок сам расставляет форму уровня и содержимое в Tiled; SceneFacade.cpp/ChunkAssembler.cpp
// только интерпретируют результат — подробности слоёв/типов объектов см. в комментарии у loadTiledLevel().
