...
// SceneFacade::run()). При успешном открытии все ключи сразу списываются из мешка (см. update() в .cpp) — своё
// дело уже сделали, незачем занимать слоты инвентаря до конца забега. При успехе зовёт
